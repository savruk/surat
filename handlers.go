...
func GetHandler(w http.ResponseWriter, r *http.Request) {
	...
	if string(item.Value) != "" {
		fromCacheGetHandler(w, r, instance, key, item)
	} else {
		fromSourceGetHandler(w, r, instance, key)
	}
}
...
func fromCacheGetHandler(w http.ResponseWriter, r *http.Request, instance cacher.Cacher, key string, item *cacher.Item) {
...
func fromSourceGetHandler(w http.ResponseWriter, r *http.Request, instance cacher.Cacher, key string) {
